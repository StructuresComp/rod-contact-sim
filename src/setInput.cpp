...
setInput::setInput() {
    ...
    AddOption("viscosity", "Viscous Force", viscosity);
    AddOption("epsilon", "epsilon", epsilon);
    AddOption("gVector", "Gravity", gVector);
    AddOption("distance", "Distance between flagella", distance);
    AddOption("numFlagella", "Number of Flagella", numFlagella);
    AddOption("axisLengthInput", "axisLengthInput", axisLengthInput);
    AddOption("deltaLengthInput", "deltaLengthInput", deltaLengthInput);
    AddOption("omega", "rotation speed for flagella", omega);
    AddOption("mu", "Coefficient of friction", mu);
    AddOption("nu", "Friction slipping tolerance", nu);
    AddOption("delta", "Contact distance tolerance", delta);
    AddOption("colLimit", "Distance limit for candidate set", col_limit);
    AddOption("lineSearch", "Flag for enabling line search", line_search);
    AddOption("ipc", "Flag for enabling IPC as contact over IMC", ipc);
